...
class Sortfield extends Component {
    ...
    render (){
        ...
        const alphabetSort = ()=>{
            this.props.Data.sort((a, b) => a.recipe.label.localeCompare(b.recipe.label));
            this.props.updateCart();
          }
          const caloriesSort = ()=>{
            this.props.Data.sort((a, b) => parseFloat(a.recipe.calories)-parseFloat(b.recipe.calories));
            this.props.updateCart();
          }
        return(
